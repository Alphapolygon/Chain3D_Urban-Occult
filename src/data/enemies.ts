...
export const ENEMIES: readonly EnemyDefinition[] = Object.freeze([
  ...
  enemy({ id: 'neon-centipede', name: 'Neon Centipede', baseHp: 260, baseDamage: 24, attackEveryTurns: 5, growthAmount: 2 }),
  enemy({ id: 'dead-platform', name: 'Dead Platform', baseHp: 310, baseDamage: 31, attackEveryTurns: 8, growthAmount: 2 })
]);
