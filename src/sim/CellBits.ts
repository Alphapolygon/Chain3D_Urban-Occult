...
export function isMatchable(cell: Cell): boolean { return isOccupied(cell) && !isStatic(cell) && !isLocked(cell) && colorOf(cell) > 0; }
export function isDestructible(cell: Cell): boolean { return isOccupied(cell) && !isStatic(cell) && !isCore(cell); }
